...
public class DownLoadTask implements Serializable {
    ...
    private WeakReference<DownLoadResultListener> mReference;
    private DownLoadMsgConfig mDownLoadMsgConfig;

    public DownLoadTask(int id, String url, DownLoadResultListener downLoadResultListeners, boolean isForce, boolean enableIndicator, Context context, File file, long length, DownLoadMsgConfig downLoadMsgConfig, int drawableRes) {
        this.id = id;
        this.url = url;
        ...
        mReference = new WeakReference<>(downLoadResultListeners);
    ...
    public void setDownLoadMsgConfig(DownLoadMsgConfig downLoadMsgConfig) {
